...
export default function PromotionalImage({ productTitle }: PromotionalImageProps) {
  return (
    <div className="relative bg-gradient-to-br from-purple-600 to-blue-600 rounded-lg p-8 text-white overflow-hidden">
      ...
      {/* 100% SATISFACTION Badge - Right */}
      <div className="flex justify-end mb-6">
        <div className="relative">
          <div className="absolute inset-0 bg-yellow-400 rounded-full blur-sm"></div>
          <div className="relative bg-yellow-400 rounded-full p-4 border-4 border-yellow-300">
      ...
      {/* Order Now Button */}
      <div className="mb-6">
        <button className="w-full bg-gradient-to-r from-green-400 to-green-600 text-white font-bold py-4 px-6 rounded-lg text-xl hover:from-green-500 hover:to-green-700 transition-all shadow-lg">
          Order Now
        </button>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="bg-white rounded-lg p-3 flex items-center gap-3">
          ...
          <span className="text-green-600 font-semibold">WhatsApp: +1(678) 609-3906</span>
        </div>
        ...
        <div className="bg-white rounded-lg p-3 flex items-center gap-3">
          ...
          <span className="text-blue-600 font-semibold">Telegram: @usatopseller</span>
        </div>
      </div>
    </div>
  );
