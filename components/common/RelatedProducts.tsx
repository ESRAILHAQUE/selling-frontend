              ...
              <div className="relative bg-gradient-to-br from-purple-600 to-blue-600 p-6 text-white">
                ...
                <div className="space-y-2 text-xs">
                  <div className="bg-white rounded p-2 flex items-center gap-2">
                    ...
                    <a href="https://wa.me/17122982593" target="_blank" rel="noopener noreferrer" className="text-green-600 font-semibold text-xs hover:underline">WhatsApp: +1(712)298-2593</a>
                  </div>
                  <div className="bg-white rounded p-2 flex items-center gap-2">
                    ...
                    <a href="https://t.me/Usamarketsmm" target="_blank" rel="noopener noreferrer" className="text-blue-600 font-semibold text-xs hover:underline">Telegram: @Usamarketsmm</a>
                  </div>
                </div>
              </div>
