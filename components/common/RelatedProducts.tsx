              ...
              <div className="relative bg-gradient-to-br from-purple-600 to-blue-600 p-6 text-white">
                ...
                <div className="space-y-2 text-xs">
                  <div className="bg-white rounded p-2 flex items-center gap-2">
                    ...
                    <span className="text-green-600 font-semibold text-xs">WhatsApp: +1(678) 609-3906</span>
                  </div>
                  <div className="bg-white rounded p-2 flex items-center gap-2">
                    ...
                    <span className="text-blue-600 font-semibold text-xs">Telegram: @usatopseller</span>
                  </div>
                </div>
              </div>
